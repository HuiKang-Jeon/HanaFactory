...
const ITEMS = [
  {
    cls: "big",
    bg: "linear-gradient(135deg,#1a1400,#2e2200)",
    tag: "ECO BAG",
    tagColor: "var(--amber)",
    img: "/images/임의.png",
    nm: { ko: "패션 브랜드 에코백", ja: "ファッションブランド エコバッグ" },
    meta: {
      ko: "수량: 3,000개 · 10oz 캔버스 · 납기: 3주",
      ja: "数量：3,000枚 · 10ozキャンバス · 納期：3週間",
    },
  },
  {
    ...
    tag: "BACKPACK",
    tagColor: "#3d8c5a",
    img: null, // "/images/portfolio/backpack-outdoor.jpg"
  ...
  },
  {
    ...
    tag: "CROSS BAG",
    tagColor: "#8c3d6a",
    img: null, // "/images/portfolio/crossbag-ladies.jpg"
  ...
  },
  {
    ...
    tag: "OEM",
    tagColor: "#2a5c8c",
    img: null, // "/images/portfolio/oem-corporate.jpg"
    nm: { ko: "기업 단체 가방", ja: "企業ノベルティバッグ" },
    meta: {
      ko: "1,000개 · 폴리에스터 · 3주",
      ja: "1,000個 · ポリエステル · 3週間",
    },
  },
  {
    cls: "wide",
    ...
    tag: "OEM SERIES",
    tagColor: "var(--amber)",
    img: null, // "/images/portfolio/oem-sports-series.jpg"
    nm: { ko: "스포츠 브랜드 OEM 시리즈", ja: "スポーツブランドOEMシリーズ" },
    meta: {
      ko: "2,000개 · 메쉬/나일론 · 6주",
      ja: "2,000個 · メッシュ/ナイロン · 6週間",
    },
  },
  {
    ...
    tag: "TOTE",
    tagColor: "#8c8c2a",
    img: null, // "/images/portfolio/totebag-bulk.jpg"
  ...
  },
  {
    ...
    tag: "POUCH",
    tagColor: "#6a2a8c",
    img: null, // "/images/portfolio/pouch-clutch.jpg"
  ...
  },
  {
    ...
    tag: "ECO",
    tagColor: "#2a8c5a",
    img: null, // "/images/portfolio/eco-campaign.jpg"
    nm: { ko: "친환경 캠페인백", ja: "エコキャンペーンバッグ" },
    meta: {
      ko: "800개 · 재생면 · 4주",
      ja: "800枚 · リサイクルコットン · 4週間",
    },
  },
];
    ...
    <section id="portfolio">
      <div className="container">
        <p className="sec-label r" ref={r0}>
          <T ko="납품 포트폴리오" ja="納品実績" />
        </p>
        <h2 className="sec-title r d1" ref={r1}>
          <T ko="말보다 실적" ja="実績が証明" />
        </h2>
        <div className="bar r d2" ref={r2} />
        <p className="sec-desc r d3" ref={r3}>
          <T
            ko="실제 납품 사례입니다. 사진 위에 마우스를 올리면 상세 정보를 볼 수 있습니다."
            ja="実際の納品実績です。写真にカーソルを合わせると詳細が表示されます。"
          />
        </p>
      </div>

      <div
        style={{ maxWidth: 1160, margin: "56px auto 0", padding: "0 44px" }}
        className="r"
        ref={r4}
      >
            ...
            >
              ...
              <div className="port-over">
                ...
                <div className="port-name">
                  <T ko={item.nm.ko} ja={item.nm.ja} />
                </div>
                <div className="port-meta">
                  <T ko={item.meta.ko} ja={item.meta.ja} />
                </div>
              </div>
            </div>
          ))}
...
//         />
//         <path
//           d="M30 32c0-8 4-14 10-14s10 6 10 14"
//           stroke="#c8922a"
//           strokeWidth="2"
//           fill="none"
//           strokeLinecap="round"
...
//           strokeLinecap="round"
//         />
//         <circle cx="40" cy="14" r="4" fill="#c87aaa" opacity=".35" />
//       </svg>
//     ),
//   },
//   {
